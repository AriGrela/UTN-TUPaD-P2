...
public class Main {
    public static void main(String[] args) {
        ...
        pepe.agregarExamen(new ExamenEscrito(40, 7, "00/00/000"));
        pepe.agregarExamen(new ExamenOral(NivelSatisfaccion.SUFICIENTE, "00/00/0000"));
        
        maria.agregarExamen(new ExamenEscrito(60,4, "00/00/000"));
        maria.agregarExamen(new ExamenEscrito(65,2, "00/00/000"));
        maria.agregarExamen(new ExamenOral(NivelSatisfaccion.EXCELENTE, "00/00/000"));
